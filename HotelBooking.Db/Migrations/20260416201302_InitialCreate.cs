        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Hotel_StarRate", "[StarRate] >= 1 AND [StarRate] <= 5");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Booking_NumberOfAdults", "[NumberOfAdults] >= 1 AND [NumberOfAdults] <= 10");
                    table.CheckConstraint("CK_Booking_NumberOfChildren", "[NumberOfChildren] >= 0 AND [NumberOfChildren] <= 10");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Room_AdultCapacity", "[AdultCapacity] >= 1 AND [AdultCapacity] <= 10");
                    table.CheckConstraint("CK_Room_ChildCapacity", "[ChildCapacity] >= 0 AND [ChildCapacity] <= 10");
                    table.ForeignKey(
